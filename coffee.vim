...
hi def link coffeeGlobal Statement
...
" Id with assignment
syn match coffeeDefinition /\<\w\+\>\( *=[^=]\)\@=/ display
hi def link coffeeDefinition BoldId

" SCREAMING_CAPS assignment
syn match coffeeConstantSet /\<\u[A-Z0-9_]*\>\( *=[^=]\)\@=/ display
hi def link coffeeConstantSet BoldIdCaps
